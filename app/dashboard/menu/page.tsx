...
export default function MenuManagement() {
  ...
  const uploadImage = async (file: File): Promise<string> => {
    ...
    try {
      // Converter arquivo para base64 ou usar uma URL de exemplo
      const reader = new FileReader()
      return new Promise((resolve, reject) => {
        reader.onload = () => {
          // Simular upload bem-sucedido com uma URL de exemplo
          // Em produção, aqui você faria upload para Firebase Storage
          const imageUrl = `https://images.unsplash.com/photo-1546548970-71785318a17b?w=300&h=300&fit=crop&crop=center&sig=${Date.now()}`
